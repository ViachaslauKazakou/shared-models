...
def test_categories_and_subcategories():
    ...
    try:
        ...
        print(
            f"   Категория '{category_with_subcategories.name}' имеет {len(category_with_subcategories.subcategories)} подкатегорий"
        )
        ...
        # Категория -> Топики
        print(
            f"   Категория '{category_with_subcategories.name}' имеет {len(category_with_subcategories.topics)} топиков"
        )
        ...
        print(
            f"     Подкатегория: {topic_with_relations.subcategory.name if topic_with_relations.subcategory else 'Нет'}"
        )
